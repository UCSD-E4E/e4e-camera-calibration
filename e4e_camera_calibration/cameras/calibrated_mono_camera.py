...
class CalibratedMonoCamera(CalibratedCameraBase, MonoCamera):
    def __init__(self, camera: MonoCamera, **kwargs) -> None:
    ...
    def camera_matrix(self) -> np.ndarray:
        return self._throw_error_if_none(
            self._camera_matrix, "Right camera matrix is not initialized."
        )
    ...
    def calibrate(
        ...
        (
            ...
            images, rows, columns, square_size, max_error=max_error, camera_name="tg6"
        )
    ...
    def _save_calibration(self, file: tarfile.TarFile):
        ...
        self._add_numpy_array(self._camera_matrix, "_calibration_matrix.npy", file)
        # self._add_numpy_array(
